...
class PengalamanKerjas {
    ...
    async createPengalamanKerja(id_user, lokasi, jabatan, detail, tahun_mulai, tahun_selesai) {
        const pengalamanKerja = await PengalamanKerja.create({ id_user, lokasi, jabatan, detail, tahun_mulai, tahun_selesai });
        return pengalamanKerja;
    }

    async updatePengalamanKerja(id, id_user, lokasi, jabatan, detail, tahun_mulai, tahun_selesai) {
        ...
        return await PengalamanKerja.update(
            { lokasi, jabatan, detail, tahun_mulai, tahun_selesai },
            {
                select :{
                    id_user,
                },
